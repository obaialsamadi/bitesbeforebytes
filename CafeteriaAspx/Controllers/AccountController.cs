...
namespace CafeteriaAspx.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(User user)
        {
            ...
            {
                User usr = db.Users.Where(u => (u.Email == user.Email && user.Password == user.Password)). FirstOrDefault();
                ...
                if(usr != null)
                {
                    ...
                    ViewBag.Email = usr.Id;
                    return RedirectToAction("Index", "Home");
                }
                else
                {
                    ViewBag.ErrorMsg = "Login Unsuccessful!";
                    Session["Email"] = null;
                    Session["UserId"] = null;
        ...
        public async Task<ActionResult> Register(User user)
        {
            ...
            using ( var db = new AppDB())
            {
                ...
                if(usr != null)
                {
                    ViewBag.ErrMsg = "User Exists Already!";
                }
                else
                {
                    db.Users.Add(user);
                    db.SaveChanges();
                    ViewBag.SuccessMsg = "User Successfully Added!";
                }
            }
            return View();
        }
